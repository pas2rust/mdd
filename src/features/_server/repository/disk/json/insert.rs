use crate::{
    features::_server::repository::disk::get_disk::{get_disk, Disk},
    helpers::{get_attributes::get_attributes, get_struct_name::get_struct_name},
};
use quote::quote;
use syn::DeriveInput;

pub fn generate_disk_insert_json(input: &DeriveInput) -> proc_macro2::TokenStream {
    ...
    let Disk {
        ...
        vec,
        ..
    } = get_disk(struct_name, attributes);
